...
M.setup = function()
  ...
  local groups = {
    ...
    -- gitsigns.nvim
    GitSignsChange = config.transparent_mode and { fg = colors.fg10 }
      or { fg = colors.fg10, bg = colors.bg0, },
    GitSignsAdd = config.transparent_mode and { fg = colors.fg10, reverse = config.invert_signs }
