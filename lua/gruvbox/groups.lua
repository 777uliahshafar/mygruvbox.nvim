...
M.setup = function()
  ...
  local groups = {
    ...
    GruvboxForest = { fg = colors.forest },
    GruvboxForestBold = { fg = colors.forest, bold = config.bold },
    ...
    CursorLine = { bg = colors.bg10 },
    CursorColumn = { link = "CursorLine" },
    TabLineFill = { fg = colors.bg4, bg = colors.choco, reverse = config.invert_tabline },
    TabLineSel = { fg = colors.fg1, bg = colors.bg1, reverse = config.invert_tabline },
    ...
    StatusLine = { fg = colors.fg6, bg = colors.bg6 },
    ...
    Comment = { fg = colors.fg7, italic = config.italic.comments },
    ...
    ["@nospell.markdown_inline"] = { fg = colors.blue, underline = config.underline },
    ...
    ["@markup.raw.block.markdown"] = { link = "GruvboxForest" },
    ["@markup.raw.markdown_inline"] = { link = "GruvboxForest" },
    ...
    NvimTreeIndentMarker = { fg = colors.chunk },
    ...
    htmlBoldItalic = { fg = colors.fg5, bg = colors.bg0, bold = config.bold, italic = true },
    ...
    htmlUnderline = { fg = colors.fg5, bg = colors.bg0, underline = config.underline },
    htmlUnderlineItalic = {
      fg = colors.fg5,
      bg = colors.bg0,
      italic = true,
    ...
    htmlItalic = { fg = colors.fg5, bg = colors.bg0, italic = true },
    ...
    -- markdown
    markdownItalic = { fg = colors.fg5, italic = true },
    markdownBold = { fg = colors.fg5, bold = config.bold },
    markdownBoldItalic = { fg = colors.fg5, bold = config.bold, italic = true },
    markdownH1 = { link = "GruvboxOrange" },
    markdownH2 = { link = "GruvboxAqua" },
    markdownH3 = { link = "GruvboxPurple" },
    markdownH4 = { link = "GruvboxGreen" },
    markdownH5 = { link = "GruvboxFg1" },
    markdownH6 = { link = "GruvboxFg1" },
