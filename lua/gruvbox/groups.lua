...
M.setup = function()
  ...
  local groups = {
    ...
    NormalFloat = config.transparent_mode and { fg = colors.fg1, bg = nil } or { fg = colors.fg1, bg = colors.bg5 },
    ...
    SpellBad = { fg = colors.red, bg = nil, italic = config.italic.comments, reverse = config.invert_signs },
