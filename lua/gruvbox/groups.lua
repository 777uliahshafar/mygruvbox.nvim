...
M.setup = function()
  ...
  local groups = {
    ...
    SpellCap = { fg = colors.blue, bg = colors.bg0, reverse = config.invert_signs },
    SpellBad = { fg = colors.red, bg = colors.bg0, reverse = config.invert_signs },
    SpellLocal = { fg = colors.aqua, bg = colors.bg0, reverse = config.invert_signs },
    SpellRare = { fg = colors.purple, bg = colors.bg0, reverse = config.invert_signs },
